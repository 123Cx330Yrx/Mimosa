...
import './App.css'
import { BaselineNotification } from './audio/BaselineNotification'
...
function BaselineApp() {
  ...
  const roleClaimNotification = useRef<BaselineNotification | null>(null)
  ...
  async function joinMeeting() {
    ...
    roleClaimNotification.current ??= new BaselineNotification()
